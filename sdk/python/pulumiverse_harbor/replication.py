...
class ReplicationArgs:
    def __init__(__self__, *,
                 ...
                 registry_id: pulumi.Input[builtins.int],
                 copy_by_chunk: Optional[pulumi.Input[builtins.bool]] = None,
                 deletion: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 dest_namespace: Optional[pulumi.Input[builtins.str]] = None,
                 dest_namespace_replace: Optional[pulumi.Input[builtins.int]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 execute_on_changed: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.int] registry_id: The registry ID of the Registry Endpoint.
        :param pulumi.Input[builtins.bool] copy_by_chunk: Specify whether to enable the artifact blobs copied by chunks. (Default: `false`)
        :param pulumi.Input[builtins.bool] deletion: Specify whether to delete the remote resources when locally deleted. (Default: `false`)
        :param pulumi.Input[builtins.str] description: Description of the replication policy.
        :param pulumi.Input[builtins.str] dest_namespace: Specify the destination namespace. if empty, the resource will be put under the same namespace as the source.
        :param pulumi.Input[builtins.int] dest_namespace_replace: Specify the destination namespace flattening policy. Integers from `-1` to `3` are valid values in the harbor API. A value of `-1` will 'Flatten All Levels', `0` means 'No Flattening', `1` 'Flatten 1 Level', `2` 'Flatten 2 Levels', `3` 'Flatten 3 Levels' (Default: `-1`, see [Replication Rules](https://goharbor.io/docs/latest/administration/configuring-replication/create-replication-rules/) for more details)
        :param pulumi.Input[builtins.bool] enabled: Specify whether the replication is enabled. (Default: `true`)
        :param pulumi.Input[builtins.bool] execute_on_changed: Specify whether to execute the replication rule if new or modified. (Default: `false`)
        :param pulumi.Input[builtins.str] name: The name of the replication.
        :param pulumi.Input[builtins.bool] override: Specify whether to override the resources at the destination if a resources with the same name exist. (Default: `true`)
        :param pulumi.Input[builtins.str] schedule: The scheduled time of when the container register will be push / pull. In cron base format. Hourly `"0 0 * * * *"`, Daily `"0 0 0 * * *"`, Monthly `"0 0 0 * * 0"`. Can be one of the following: `event_based`, `manual`, `cron format` (Default: `manual`)
        :param pulumi.Input[builtins.int] speed: The Maximum network bandwidth in Kbps for each execution. Default is `-1` (unlimited).
        """
    ...
    def registry_id(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @registry_id.setter
    def registry_id(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "registry_id", value)

    @property
    @pulumi.getter(name="copyByChunk")
    def copy_by_chunk(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def copy_by_chunk(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def dest_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dest_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dest_namespace", value)

    @property
    @pulumi.getter(name="destNamespaceReplace")
    def dest_namespace_replace(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specify the destination namespace flattening policy. Integers from `-1` to `3` are valid values in the harbor API. A value of `-1` will 'Flatten All Levels', `0` means 'No Flattening', `1` 'Flatten 1 Level', `2` 'Flatten 2 Levels', `3` 'Flatten 3 Levels' (Default: `-1`, see [Replication Rules](https://goharbor.io/docs/latest/administration/configuring-replication/create-replication-rules/) for more details)
        """
    ...
    def dest_namespace_replace(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def execute_on_changed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def execute_on_changed(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ReplicationState:
    def __init__(__self__, *,
                 ...
                 replication_policy_id: Optional[pulumi.Input[builtins.int]] = None,
                 schedule: Optional[pulumi.Input[builtins.str]] = None,
                 speed: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    def replication_policy_id(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "replication_policy_id")

    @replication_policy_id.setter
    def replication_policy_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Replication(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 execute_on_changed: Optional[pulumi.Input[builtins.bool]] = None,
                 filters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ReplicationFilterArgs', 'ReplicationFilterArgsDict']]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 override: Optional[pulumi.Input[builtins.bool]] = None,
                 registry_id: Optional[pulumi.Input[builtins.int]] = None,
                 schedule: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def get(resource_name: str,
            ...
            replication_policy_id: Optional[pulumi.Input[builtins.int]] = None,
            schedule: Optional[pulumi.Input[builtins.str]] = None,
            speed: Optional[pulumi.Input[builtins.int]] = None) -> 'Replication':
        """
    ...
    @property
    @pulumi.getter(name="copyByChunk")
    def copy_by_chunk(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specify whether to enable the artifact blobs copied by chunks. (Default: `false`)
        """
        return pulumi.get(self, "copy_by_chunk")
    ...
    @property
    @pulumi.getter
    def deletion(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specify whether to delete the remote resources when locally deleted. (Default: `false`)
        """
        return pulumi.get(self, "deletion")
    ...
    @property
    @pulumi.getter(name="destNamespace")
    def dest_namespace(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify the destination namespace. if empty, the resource will be put under the same namespace as the source.
        """
        return pulumi.get(self, "dest_namespace")
    ...
    @property
    @pulumi.getter(name="destNamespaceReplace")
    def dest_namespace_replace(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specify the destination namespace flattening policy. Integers from `-1` to `3` are valid values in the harbor API. A value of `-1` will 'Flatten All Levels', `0` means 'No Flattening', `1` 'Flatten 1 Level', `2` 'Flatten 2 Levels', `3` 'Flatten 3 Levels' (Default: `-1`, see [Replication Rules](https://goharbor.io/docs/latest/administration/configuring-replication/create-replication-rules/) for more details)
        """
        return pulumi.get(self, "dest_namespace_replace")
    ...
    @property
    @pulumi.getter(name="executeOnChanged")
    def execute_on_changed(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specify whether to execute the replication rule if new or modified. (Default: `false`)
        """
        return pulumi.get(self, "execute_on_changed")
    ...
    @property
    @pulumi.getter(name="replicationPolicyId")
    def replication_policy_id(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "replication_policy_id")
