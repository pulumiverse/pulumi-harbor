...
class RetentionPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] scope: The project id of which you would like to apply this policy.
        :param pulumi.Input[builtins.str] schedule: The schedule of when you would like the policy to run. This can be `Hourly`, `Daily`, `Weekly` or can be a custom cron string.
        """
...
class RetentionPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RetentionPolicyRuleArgs', 'RetentionPolicyRuleArgsDict']]]]] = None,
            schedule: Optional[pulumi.Input[builtins.str]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'RetentionPolicy':
        """
