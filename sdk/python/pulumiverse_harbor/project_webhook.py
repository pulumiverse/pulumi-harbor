...
class ProjectWebhookArgs:
    def __init__(__self__, *,
                 ...
                 events_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 notify_type: pulumi.Input[builtins.str],
                 project_id: pulumi.Input[builtins.str],
                 auth_header: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 skip_cert_verify: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a ProjectWebhook resource.
        :param pulumi.Input[builtins.str] address: The address of the webhook.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events_types: The type events you want to subscript to can be
        :param pulumi.Input[builtins.str] notify_type: The notification type either `http` or `slack`.
        :param pulumi.Input[builtins.str] project_id: The project id of the harbor that webhook related to.
        :param pulumi.Input[builtins.str] name: The name of the webhook that will be created in harbor.
        """
    ...
    def events_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @events_types.setter
    def events_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def auth_header(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "auth_header")

    @auth_header.setter
    def auth_header(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def skip_cert_verify(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "skip_cert_verify")

    @skip_cert_verify.setter
    def skip_cert_verify(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ProjectWebhookState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 events_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="eventsTypes")
    def events_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The type events you want to subscript to can be
        """
        return pulumi.get(self, "events_types")
    ...
    @events_types.setter
    def events_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "events_types", value)
...
class ProjectWebhook(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            notify_type: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            skip_cert_verify: Optional[pulumi.Input[builtins.bool]] = None) -> 'ProjectWebhook':
        """
    ...
    @property
    @pulumi.getter(name="authHeader")
    def auth_header(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "auth_header")
    ...
    @property
    @pulumi.getter(name="eventsTypes")
    def events_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The type events you want to subscript to can be
        """
        return pulumi.get(self, "events_types")
    ...
    @property
    @pulumi.getter(name="notifyType")
    def notify_type(self) -> pulumi.Output[builtins.str]:
        """
        The notification type either `http` or `slack`.
        """
        return pulumi.get(self, "notify_type")
    ...
    @property
    @pulumi.getter(name="skipCertVerify")
    def skip_cert_verify(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "skip_cert_verify")
