...
class InterrogationServicesArgs:
    def __init__(__self__, *,
                 vulnerability_scan_policy: pulumi.Input[builtins.str],
                 default_scanner: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a InterrogationServices resource.
        :param pulumi.Input[builtins.str] vulnerability_scan_policy: The frequency of the vulnerability scanning is done. This can be `Daily`, `Weekly`, `Monthly` or can be a custom cron string.
        :param pulumi.Input[builtins.str] default_scanner: Sets the default interrogation service `"Clair"`
        """
    ...
    def vulnerability_scan_policy(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vulnerability_scan_policy(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "vulnerability_scan_policy", value)

    @property
    @pulumi.getter(name="defaultScanner")
    def default_scanner(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_scanner(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _InterrogationServicesState:
    def __init__(__self__, *,
                 default_scanner: Optional[pulumi.Input[builtins.str]] = None,
                 vulnerability_scan_policy: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="vulnerabilityScanPolicy")
    def vulnerability_scan_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The frequency of the vulnerability scanning is done. This can be `Daily`, `Weekly`, `Monthly` or can be a custom cron string.
        """
        return pulumi.get(self, "vulnerability_scan_policy")
    ...
    @vulnerability_scan_policy.setter
    def vulnerability_scan_policy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vulnerability_scan_policy", value)
...
class InterrogationServices(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            default_scanner: Optional[pulumi.Input[builtins.str]] = None,
            vulnerability_scan_policy: Optional[pulumi.Input[builtins.str]] = None) -> 'InterrogationServices':
        """
    ...
    @property
    @pulumi.getter(name="defaultScanner")
    def default_scanner(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Sets the default interrogation service `"Clair"`
        """
        return pulumi.get(self, "default_scanner")
    ...
    @property
    @pulumi.getter(name="vulnerabilityScanPolicy")
    def vulnerability_scan_policy(self) -> pulumi.Output[builtins.str]:
        """
        The frequency of the vulnerability scanning is done. This can be `Daily`, `Weekly`, `Monthly` or can be a custom cron string.
        """
        return pulumi.get(self, "vulnerability_scan_policy")
